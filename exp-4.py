print("-------Darsh Jain-----1/22/FET/BCS/182-------6CSC2-------",'\n')
# Reading the dataset
import pandas as pd
import numpy as np
...
fig.suptitle('Plot Bar for Categorical Variables in the dataset')
sns.countplot( x = 'Clean Alternative Fuel Vehicle (CAFV) Eligibility', data = df, color = 'red', 
